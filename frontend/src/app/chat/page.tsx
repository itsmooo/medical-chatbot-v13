      ...
      <main className="flex-grow pt-24 pb-16 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 reveal">
            <div className="inline-block mb-4 pill bg-primary/10 text-primary">AI Health Assistant</div>
          ...
          <div className="max-w-3xl mx-auto reveal">
            <div className="glass-morphism p-6 md:p-8 relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-6 pb-4 border-b">
                ...
                <div className="pill bg-green-50 text-green-700 flex items-center">
